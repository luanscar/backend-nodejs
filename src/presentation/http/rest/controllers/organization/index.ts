...
import { DeleteOrganizationExpressController } from "./delete-organization.express.controller";

const createOrganizationController = new CreateOrganizationExpressController(
  createOrganizationUseCase
);
const getUserOrganizationsController =
  new GetUserOrganizationsExpressController(getUserOrganizationsUseCase);
const getOrganizationController = new GetOrganizationExpressController(
  getOrganizationUseCase
);
const getMembershipController = new GetMembershipExpressController();
const transferOrganizationController =
  new TransferOrganizationExpressController(transferOrganizationUseCase);
const deleteOrganizationController = new DeleteOrganizationExpressController(
  deleteOrganizationUseCase
);
